...
const Table = forwardRef<HTMLDivElement, GridTableProps>(
  (
    ...
    useImperativeHandle(imperativeRef, () => ({
      ...
      setColumnVisible: (key, visible, options) => {
        return setColumnVisible?.(key, visible, options) ?? false;
      },
          ...
          <ColumnPreviewStyleScope
            ...
            className={classNames(
              ...
              hashId,
              {
                ...
                [fixColumnsCls]: hasFixedColumns,
                [hasFixStartCls]: fixedOffset.hasFixStartColumns,
                [hasFixEndCls]: fixedOffset.hasFixEndColumns,
